...
var Papersize = /** @class */ (function (_super) {
...
function default_1(commands) {
    return __asyncGenerator(this, arguments, function () {
        var commands_1, commands_1_1, command, sizes, width, height, e_1_1;
        var e_1, _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 4:
                    ...
                    return [3 /*break*/, 11];
                case 5:
                    if (!!command.x.startsWith('papersize=')) return [3 /*break*/, 8];
                    return [4 /*yield*/, __await(command)];
                ...
                case 8:
                    ...
                    return [4 /*yield*/, __await(new Papersize(width, height))];
