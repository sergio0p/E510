...
\textcolor{magenta}{Prerequisites} ECON 410 with a grade of C or better.  \vv
...
\textcolor{magenta}{Required software/apps}\\ \textcolor{yellow}{Mathematica}: order it free at \href{https://software.unc.edu}{https://software.unc.edu}.\\ No prior knowledge of Mathematica is necessary for one to succeed in this course but as Mathematica  is used on an regular basis make sure to install it on your laptop as soon as possible.\\
\textcolor{yellow}{Zoom}: used in Tuesday's classes to discuss homework.\\
\textcolor{yellow}{Overleaf}: open a free individual account at \href{https://www.overleaf.com/}{Overleaf.com}. You will use Overleaf to typeset amd share research assignments using \LaTeX markup. \newpage
\noindent\textcolor{magenta}{Learning Objectives}\\
...
objectionable and, you may feel uncomfortable. I will not endorse or advocate any particular political views but as part of your university  education, I wholeheartedly believe that is important for us to engage in critical
 ...
 You are expected to attend class, read the assigned readings and, be prepared to discuss and present your work in the classroom.\newpage \newpage
...
\newpage
\restoregeometry
{\large {\textcolor{orange}{Policies and procedures}}}
\begin{description}
