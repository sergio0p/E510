...
3. **If the file isn't in References/, copy it** from `/usr/local/texlive/2025/texmf-dist/tex/generic/pgf/`.
...
**Key modules:**
- `shapes/shape.js` — registry + `createShape` factory + `polygonBorderPoint` helper
